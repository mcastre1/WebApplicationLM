...
namespace WebApplicationLM.Controllers
{
    public class CardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CardId,Title,Details,Priority")] Card card)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CardId,Title,Details,Priority")] Card card)
        {
            if (id != card.CardId)
            {
                return NotFound();
